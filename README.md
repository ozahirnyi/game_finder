...
The application is deployed at [https://playfinder.cc](https://playfinder.cc).

### API Docs

[https://playfinder.cc/api/docs](https://playfinder.cc/api/docs)
...
The workflow runs tests, builds Compose services, applies Alembic migrations, starts the stack, and verifies `http://127.0.0.1:8000/health`. Nginx serves the frontend from port 3000 and proxies API requests from `https://playfinder.cc/api/` to port 8000. It does not require AWS credentials or CodeDeploy.
