              ...
              {friends.map((f) => (
                ...
                >
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="mt-0.5 truncate text-xs text-muted-foreground">{f.activity}</p>
                  ...
                  <div className="hidden text-right sm:block">
                    ...
                    <p className="font-mono text-lg font-black text-primary">{f.compatibility}%</p>
          ...
          <div className="rounded-3xl border border-border bg-surface p-6">
            ...
            <div className="my-6 grid grid-cols-3 gap-3 border-y border-border py-4 text-center font-mono">
              <div>
                ...
                <p className="text-xl font-black text-primary">{focus.compatibility}%</p>
              </div>
              <div>
                <p className="text-[10px] uppercase tracking-widest text-muted-foreground">
                  Shared
