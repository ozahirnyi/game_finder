...
describe("PsnImportFlow", () => {
  ...
  it("selects recommended games and leaves suggested non-games out of the import", async () => {
    previewPsnImport.mockResolvedValueOnce({
      items: [
        ...
        {
          source_title: "EA Play",
          status: "suggested_skip",
          recommended_action: "skip",
          candidate_token: "ea-play",
          igdb_id: null,
          title: null,
        },
      ],
    ...
    await waitFor(() =>
      expect(confirmPsnImport.mock.calls[0]?.[0]).toEqual([
        { candidate_token: "gow", action: "catalog", catalog_id: 101 },
      ]),
    );
  });
});
