...
- Health endpoint: `https://example.com/api/health`
...
- Do not claim production changed merely because the PR merged. Verify the workflow has conclusion `success` and call `https://example.com/api/health`.
