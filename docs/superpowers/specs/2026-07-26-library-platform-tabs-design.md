...
- After merging, wait for `Deploy to Lightsail over SSH` for the merged SHA and verify `https://example.com/api/health`. Do not consider production updated solely because a PR merged.
